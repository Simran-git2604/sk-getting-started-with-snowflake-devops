...
CREATE OR REPLACE GIT REPOSITORY quickstart_common.public.quickstart_repo
  ...
  ORIGIN = 'https://github.com/Simran-git2604/sk-getting-started-with-snowflake-devops'; 
...
CREATE OR REPLACE FILE FORMAT bronze.json_format TYPE = 'json'; -- file format
CREATE OR ALTER STAGE bronze.raw; -- stage object


-- Copy from GitHub to internal stage
